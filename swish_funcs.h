 ...
 * into tokens. These tokens are stored in the 'tokens' vector.
 ...
 * is_foreground: 1 if the job should be resumed in the foreground, or
 *                0 if the job should be resumed in the background
 * Returns 0 on success or -1 on error
 */
